...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-stone-950 flex flex-col transition-colors">
      ...
      {/* ─── DASHBOARD SECTION: Market Overview ─── */}
      <div className="px-5 lg:px-7 pt-5 pb-2 space-y-3.5">
        {/* Status line */}
        <div className="flex items-center gap-3">
          ...
          <span className="text-stone-400 text-[11px]">{totalJobs} positions · updated daily</span>
        ...
        {/* Category cards + Market chart in a row */}
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr_280px] gap-3.5">
      ...
      {/* ─── JOBS SECTION: The main content ─── */}
      <div className="flex-1 px-5 lg:px-7 py-3.5">
