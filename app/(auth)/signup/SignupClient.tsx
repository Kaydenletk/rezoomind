            ...
            <div key={f.key} className="space-y-1.5">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className={`w-full bg-transparent border-b border-stone-200 text-stone-900 placeholder:text-stone-400 focus:border-orange-600 outline-none py-1.5 font-mono text-sm transition-colors dark:border-stone-800 dark:text-stone-100 dark:placeholder:text-stone-600 ${f.tracking}`}
