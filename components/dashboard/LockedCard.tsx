...
export function LockedCard() {
  return (
    <div className="border-[1.5px] border-dashed border-stone-200 rounded-[10px] p-5 bg-stone-50 flex flex-col items-center justify-center text-center">
      ...
      <Link href="/login" className="bg-stone-950 text-stone-50 px-5 py-2 rounded-md text-xs font-semibold font-mono w-full text-center hover:bg-stone-800 transition-colors">
        sign_in →
      </Link>
    </div>
  );
