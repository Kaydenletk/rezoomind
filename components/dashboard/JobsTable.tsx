          ...
          postings.map((job, i) => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-xs truncate ${isApplied ? 'text-stone-400 dark:text-stone-500' : 'text-stone-700 dark:text-stone-300'}`}>{job.role}</span>
                ...
                <div className="text-right flex items-center justify-end gap-1.5">
                  <button
                    onClick={() => setTailorJob({ company: job.company, role: job.role })}
